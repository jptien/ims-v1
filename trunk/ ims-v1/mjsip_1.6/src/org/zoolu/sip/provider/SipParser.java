...
public class SipParser extends Parser {
	...
	/**
	 * Creates a new SipParser based on StringBuffer <i>sb</i> and starting from
	 * position <i>i</i>
	 */
	...
	public static boolean isMark(char c) { // return (c=='-' || c=='_' || c=='.'
											// || c=='!' || c=='~' || c=='*' ||
											// c=='\'' || c=='|');
	 ...
	 */
	/**
	 * Returns the first NameAddress in the string <i>str</i>. If no NameAddress
	 * is found, it returns <b>null</b>. A NameAddress is a string of the form
	 * of: <BR>
	 * <BLOCKQUOTE>
	 * 
	 * <PRE>
